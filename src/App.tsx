...
function PublicSite({ onEnter }: { onEnter: () => void }) {
  return <main className="site-shell">
    ...
    <section id="top" className="hero-site">
      ...
      <div className="hero-panel"><span>Sample Collection</span><strong>Portfolio view</strong><small>Inventory · documents · stewardship actions</small><div className="mini-stack"><b>Insurance schedule review</b><b>Loan inspection workflow</b><b>Advisor market memo</b></div></div>
    </section>
